...
namespace maplestory.io.Models
{
    public class Character
    {
        ...
        public static async Task<Character> GetCharacter(string characterName, string rankingMode = "overall", string rankAttribute = "legendary")
        {
            ...
            if (rankingMode != "fame")
                pattern = "<img class=\"avatar\"[ ]* src=\"([^\"]*)\"></td>[ ]*<td>(<img src=\"http://nxcache.nexon.net/maplestory/img/bg/bg-immigrant.png\"/><br />)*([^<]*)</td>[ ]*<td><a class=\"([^\"]*)\" href=\"([^\"]*)\" title=\"([^\"]*)\">&nbsp;</a></td>[ ]*<td><img class=\"job\" src=\"([^\"]*)\" alt=\"([^\"]*)\" title=\"[^\"]*\"></td>[ ]*<td class=\"level-move\">[ ]*([0-9]*)<br />[ ]*\\(([0-9]*)\\)[ ]*<br />[ ]*<div class=\"rank-([^\"]*)\">([^<]*)</div>";
            else
                pattern = "<img class=\"avatar\"[ ]* src=\"([^\"]*)\"></td>[ ]*<td>(<img src=\"http://nxcache.nexon.net/maplestory/img/bg/bg-immigrant.png\"/><br />)*([^<]*)</td>[ ]*<td><a class=\"([^\"]*)\" href=\"([^\"]*)\" title=\"([^\"]*)\">&nbsp;</a></td>[ ]*<td><img class=\"job\" src=\"([^\"]*)\" alt=\"([^\"]*)\" title=\"[^\"]*\"></td>[ ]*<td class=\"level-move\">[ ]*([0-9]*)";
