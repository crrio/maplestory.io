...
namespace maplestory.io.Services.MapleStory
{
    public interface ICharacterFactory : INeedWZ<ICharacterFactory>
    {
        ...
        Image<Rgba32> GetCharacter(int id, string animation = null, int frame = 0, bool showEars = false, bool showLefEars = false, int padding = 2, string name = null, RenderMode renderMode = RenderMode.Full, params Tuple<int, string, float?>[] items);
        ...
        IEnumerable<Tuple<Frame, Point, float?>> GetJsonCharacter(int id, string animation = null, int frame = 0, bool showEars = false, bool showLefEars = false, int padding = 2, string name = null, params Tuple<int, string, float?>[] items);
        Tuple<Image<Rgba32>, Dictionary<string, Point>> GetDetailedCharacter(int id, string animation = null, int frame = 0, bool showEars = false, bool showLefEars = false, int padding = 2, string name = null, RenderMode renderMode = RenderMode.Full, params Tuple<int, string, float?>[] items);
    }
}
