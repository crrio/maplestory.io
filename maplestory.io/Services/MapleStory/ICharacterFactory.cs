...
namespace maplestory.io.Services.MapleStory
{
    public interface ICharacterFactory : INeedWZ<ICharacterFactory>
    {
        ...
        byte[] GetSpriteSheet(HttpRequest request, int id, bool showEars = false, bool showLefEars = false, int padding = 2, RenderMode renderMode = RenderMode.Full, SpriteSheetFormat format = SpriteSheetFormat.Plain, params int[] itemEntries);
