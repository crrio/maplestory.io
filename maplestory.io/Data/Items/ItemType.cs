...
namespace maplestory.io.Data
{
    public class ItemType
    {
        static Dictionary<string, Tuple<string, int, int>[]> equips = new Dictionary<string, Tuple<string, int, int>[]>{
            ...
            {"One-Handed Weapon",
                new Tuple<string,int,int>[]{
                    ...
                    new Tuple<string, int, int>("Psy-limiter", 1262000, 1263000),
            ...
            {"Secondary Weapon",
                new Tuple<string,int,int>[]{
                    ...
                    new Tuple<string, int, int>("Chess Piece", 1353200, 1353300),
                    new Tuple<string, int, int>("Transmitter", 1353300, 1353400),
                    new Tuple<string, int, int>("Wings", 1353500, 1353600)
                }
            },
            {"Two-Handed Weapon",
                new Tuple<string,int,int>[]{
        ...
        static Dictionary<string, Tuple<string, int, int>[]> cash = new Dictionary<string, Tuple<string, int, int>[]>(){
            ...
            {"Free Market",
            new Tuple<string,int,int>[]{
                new Tuple<string, int, int>("Pet", 5000000, 5010000), // Not sure what the cap is, assuming it's just up to 5k pets
