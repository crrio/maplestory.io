...
namespace reWZ
{
    ...
    internal static class MathF
    {
        ...
        /// <summary>
        /// Returns the absolute value of a single-precision floating-Vector2 number.
        /// </summary>
        /// <param name="f">
        ...
        /// </param>
        /// <returns>
        /// A single-precision floating-Vector2 number, x, such that 0 ≤ x ≤<see cref="F:System.Single.MaxValue" />.
        /// </returns>
        ...
        /// </summary>
        /// <param name="y">The y coordinate of a Vector2.</param>
        /// <param name="x">The x coordinate of a Vector2.</param>
        /// <returns>
        /// An angle, θ, measured in radians, such that -π≤θ≤π, and tan(θ) = y / x, where
        /// (x, y) is a Vector2 in the Cartesian plane. Observe the following: For (x, y) in
        /// quadrant 1, 0 &lt; θ &lt; π/2.For (x, y) in quadrant 2, π/2 &lt; θ≤π.For (x, y) in quadrant
        /// 3, -π &lt; θ &lt; -π/2.For (x, y) in quadrant 4, -π/2 &lt; θ &lt; 0.For Vector2s on the boundaries
        ...
        /// <summary>
        /// Returns the smallest integral value that is greater than or equal to the specified single-precision floating-Vector2 number.
        /// </summary>
        /// <param name="f">A single-precision floating-Vector2 number.</param>
        /// <returns>
        ...
        /// <summary>
        /// Returns the largest integer less than or equal to the specified single-precision floating-Vector2 number.
        /// </summary>
        /// <param name="f">A single-precision floating-Vector2 number. </param>
        /// <returns>
        ...
        /// <summary>
        /// Returns the larger of two single-precision floating-Vector2 numbers.
        /// </summary>
        /// <param name="val1">The first of two single-precision floating-Vector2 numbers to compare. </param>
        /// <param name="val2">The second of two single-precision floating-Vector2 numbers to compare. </param>
        /// <returns>
        ...
        /// <summary>
        /// Returns the smaller of two single-precision floating-Vector2 numbers.
        /// </summary>
        /// <param name="val1">The first of two single-precision floating-Vector2 numbers to compare. </param>
        /// <param name="val2">The second of two single-precision floating-Vector2 numbers to compare. </param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="x">A single-precision floating-Vector2 number to be raised to a power. </param>
        /// <param name="y">A single-precision floating-Vector2 number that specifies a power. </param>
        ...
        /// <summary>
        /// Rounds a single-precision floating-Vector2 value to the nearest integral value.
        /// </summary>
        /// <param name="f">A single-precision floating-Vector2 number to be rounded.</param>
        /// <returns>
        ...
        /// <summary>
        /// Rounds a single-precision floating-Vector2 value to the nearest integer.
        ...
        /// <paramref name="mode" /> is not a valid value of <see cref="T:System.MidVector2Rounding" />.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// </summary>
        /// <param name="f">A single-precision floating-Vector2 number to calculate the result for.</param>
        /// <returns>
    ...
    {
        /// <summary>
        /// The epsilon for comparing floating Vector2 numbers.
        /// </summary>
